            ...
            pipeline.append(
                {
                    ...
                    "post_url": display.get("post_url"),
                    "contact_url": display.get("contact_url"),
                    "scored": display.get("scored"),
                    "lead_category": display.get("lead_category"),
                    "scorer_action": display.get("scorer_action"),
